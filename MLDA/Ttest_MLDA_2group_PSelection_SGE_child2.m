function Accuracy = Ttest_MLDA_2group_PSelection_SGE_child2(ResultantFolder, Subjects_Label)
...
% Select features which with frequency bigger than 61
Index = find(Frequency_All >= round(Subjects_Quantity * 0.9));
