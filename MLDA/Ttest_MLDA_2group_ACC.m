function Accuracy = Ttest_MLDA_2group_ACC(Subjects_Data, Subjects_Label, P_Value, Pre_Method)
%
% Subject_Data:
%           m*n matrix
...
for i = 1:Subjects_Quantity
    ...
    model(i) = MLDA_train(All_Training_New, Label);
    ...
    [predicted_labels(i), ~] = MLDA_predict(model(i), test_data_New, test_label);
